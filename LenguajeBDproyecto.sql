...
agregarHoteles(1, 'Hotel Verde', 'San JosÔøΩ', 'Central', 'Carmen', 'Av. Principal #123', '2222-3333', 5);
agregarHoteles(2, 'Hotel Vistas', 'Alajuela', 'Central', 'San JosÔøΩ', 'Calle Sol #45', '2444-5555', 3);
agregarHoteles(3, 'Hotel Flores', 'Heredia', 'San Rafael', 'Los ÔøΩngeles', 'Blvd. Este #67', '2666-7777', 4);
agregarHoteles(4, 'Hotel Catedral', 'Cartago', 'Oreamuno', 'San Rafael', 'Carretera Vieja #89', '2555-6666', 6);    
agregarHoteles(5, 'Hotel Marea', 'Puntarenas', 'Central', 'Barrio El Carmen', 'Paseo MarÔøΩtimo #101', '2777-8888', 2);
agregarHoteles(6, 'prueba eliminacion', 'Puntarenas', 'Central', 'Barrio El Carmen', 'Paseo MarÔøΩtimo #101', '2777-8888', 2);
END;
...
BEGIN
agregarProveedor(1, 'Suministros Varios CR', 'Juan PÔøΩrez', 88885555, 'contacto@suministroscr.com', 'San JosÔøΩ', 'Limpieza', TO_DATE('2023-01-15', 'YYYY-MM-DD'));
agregarProveedor(2, 'Alimentos CR', 'MarÔøΩa LÔøΩpez', 87776666, 'ventas@alimentospv.com', 'Heredia', 'Alimentos', TO_DATE('2022-12-01', 'YYYY-MM-DD'));
agregarProveedor(3, 'Gallo', 'Carlos RamÔøΩrez', 86667777, 'info@electrotico.com', 'Alajuela', 'ElectrodomÔøΩsticos', TO_DATE('2023-02-10', 'YYYY-MM-DD'));
agregarProveedor(4, 'Muebles Cartago', 'Ana GÔøΩmez', 85554444, 'soporte@mueblesfinos.com', 'Cartago', 'Mobiliario', TO_DATE('2022-11-20', 'YYYY-MM-DD'));
agregarProveedor(5, 'Decoraciones SA', 'Pedro Rojas', 84443333, 'ventas@decoraciones.com', 'Puntarenas', 'DecoraciÔøΩn', TO_DATE('2023-03-05', 'YYYY-MM-DD'));
END;
...
agregarSuministro(1, 1, 1, 'JabÔøΩn lÔøΩquido', 'JabÔøΩn antibacterial 500ml', 100, 20000);
agregarSuministro(2, 2, 2, 'CafÔøΩ premium', 'CafÔøΩ en grano 1kg', 50, 30000);
agregarSuministro(3, 3, 3, 'Televisor LED', 'Smart TV 42 pulgadas', 10, 500000);
agregarSuministro(4, 4, 4, 'SillÔøΩn de recepciÔøΩn', 'SillÔøΩn de cuero negro', 5, 200000);
...
agregarPromocion(2, 2, 'Fin de semana romÔøΩntico', TO_DATE('2025-02-14', 'YYYY-MM-DD'), TO_DATE('2025-02-16', 'YYYY-MM-DD'));
agregarPromocion(3, 3, 'EstadÔøΩa lealtad', TO_DATE('2025-03-10', 'YYYY-MM-DD'), TO_DATE('2025-04-10', 'YYYY-MM-DD'));
agregarPromocion(4, 4, 'PromociÔøΩn familiar', TO_DATE('2025-05-01', 'YYYY-MM-DD'), TO_DATE('2025-05-31', 'YYYY-MM-DD'));
...
agregarTipoPromocion(2, 'Paquete', 'Incluye alojamiento y actividades turÔøΩsticas');
agregarTipoPromocion(3, 'Upgrade gratis', 'Los huÔøΩspedes reciben una mejora de habitaciÔøΩn sin costo adicional');
agregarTipoPromocion(4, 'Puntos dobles', 'Se duplican los puntos de fidelidad en esta promociÔøΩn');
agregarTipoPromocion(5, 'Cena incluida', 'La promociÔøΩn incluye una cena gratis por noche reservada');
END;
...
BEGIN
    ...
    INSERT INTO Vehiculo (Id_Vehiculo, FK_Hotel, Tipo, Marca, Modelo, AÔøΩo, Placa)
...
BEGIN
    ...
    agregarVehiculo(1, 1, 'AutomÔøΩvil', 'Toyota', 'Corolla', 2020, 'ABC1234');
...
agregarInventario(1, 1, 'Televisor', 'ElectrÔøΩnico', 'Samsung', 'SmartTV 50"', 'SER123456', TO_DATE('2024-01-10', 'YYYY-MM-DD'), 10);
agregarInventario(2, 2, 'Aire Acondicionado', 'ElectrodomÔøΩstico', 'LG', 'Max', 'SER654321', TO_DATE('2023-12-15', 'YYYY-MM-DD'), 8);
agregarInventario(3, 3, 'ColchÔøΩn King Size', 'Mobiliario', 'Sealy', 'Suave', 'SER987654', TO_DATE('2024-02-20', 'YYYY-MM-DD'), 20);
agregarInventario(4, 4, 'Computadora', 'ElectrÔøΩnico', 'Dell', 'Inspiron 15', 'SER741852', TO_DATE('2024-03-01', 'YYYY-MM-DD'), 5);
...
agregarEmpleado(3, 3, 3, 'Keylin PeÔøΩa', 11223344, 'keypeÔøΩa@gmail.com', 87773333, TO_DATE('2023-01-20', 'YYYY-MM-DD'));
agregarEmpleado(4, 4, 4, 'JosÔøΩ FernÔøΩndez', 44332211, 'josefernandez@gmail.com', 85554444, TO_DATE('2020-11-30', 'YYYY-MM-DD'));
...
agregarHuesped(1, 'Carlos', 12345678, 'GÔøΩmez', 'RamÔøΩrez', 'carlosgomez@gmail.com', 88881111, TO_DATE('1990-05-10', 'YYYY-MM-DD'), TO_DATE('2024-02-01', 'YYYY-MM-DD'));
agregarHuesped(2, 'Ana', 87654321, 'MartÔøΩnez', 'FernÔøΩndez', 'anamartinez@gmail.com', 89992222, TO_DATE('1985-08-20', 'YYYY-MM-DD'), TO_DATE('2024-02-03', 'YYYY-MM-DD'));
agregarHuesped(3, 'Javier', 11223344, 'LÔøΩpez', 'HernÔøΩndez', 'javierlopez@gmail.com', 87773333, TO_DATE('1995-11-15', 'YYYY-MM-DD'), TO_DATE('2024-02-05', 'YYYY-MM-DD'));
agregarHuesped(4, 'SofÔøΩa', 44332211, 'RodrÔøΩguez', 'DÔøΩaz', 'sofiarodriguez@gmail.com', 85554444, TO_DATE('2000-01-25', 'YYYY-MM-DD'), TO_DATE('2024-02-07', 'YYYY-MM-DD'));
agregarHuesped(5, 'Miguel', 55667788, 'FernÔøΩndez', 'Castro', 'miguelfernandez@gmail.com', 82221111, TO_DATE('1988-06-30', 'YYYY-MM-DD'), TO_DATE('2024-02-09', 'YYYY-MM-DD'));
END;
...
agregarTipoHabitacion(2, 'HabitaciÔøΩn doble', '2 personas', 2, 'Vista a la ciudad', 20000, 'Disponible');
agregarTipoHabitacion(3, 'HabitaciÔøΩn familiar', '4 personas', 3, 'Vista al jardÔøΩn', 27500, 'Ocupado');
agregarTipoHabitacion(4, 'Penthouse', '6 personas', 5, 'Vista panorÔøΩmica', 37000, 'Mantenimiento');
...
BEGIN
    ...
    agregarMantenimiento(1, 4, 1, 'ReparaciÔøΩn de jacuzzi', TO_DATE('2024-02-15', 'YYYY-MM-DD'));
    agregarMantenimiento(2, 5, 2, 'Cambio de muebles en la sala', TO_DATE('2024-02-18', 'YYYY-MM-DD'));
    agregarMantenimiento(3, 3, 3, 'RevisiÔøΩn del aire acondicionado', TO_DATE('2024-02-20', 'YYYY-MM-DD'));
    agregarMantenimiento(4, 2, 4, 'Pintura de las paredes', TO_DATE('2024-02-22', 'YYYY-MM-DD'));
    agregarMantenimiento(5, 1, 5, 'Limpieza profunda y sanitizaciÔøΩn', TO_DATE('2024-02-25', 'YYYY-MM-DD'));
END;
...
BEGIN
    ...
    agregarRestaurante(5, 5, 'Sabores caribeÔøΩos', 30, 120);
END;
...
-- Estos inserts son los originales
    ...
    agregarReservacionRestaurante(5, 5, 5, 'Sabores caribeÔøΩos', TO_DATE('2024-03-05', 'YYYY-MM-DD'), 5);*/
...
agregarServicio(3, 'Cena RomÔøΩntica', 37000, 'GastronomÔøΩa');
agregarServicio(4, 'Tour de la Ciudad', 30000, 'Turismo');
agregarServicio(5, 'LavanderÔøΩa Express', 7000, 'Limpieza');
...
BEGIN
    /*
    agregarReservacion(1, 1, 1, 1, 1, 1, 1, 'Confirmado', 'ReservaciÔøΩn para una noche en habitaciÔøΩn con jacuzzi');
    agregarReservacion(2, 2, 2, 2, 2, 2, 2, 'Pendiente', 'HabitaciÔøΩn doble con vista a la ciudad');
    agregarReservacion(3, 3, 3, 3, 3, 3, 3, 'Confirmado', 'HabitaciÔøΩn familiar con cama matrimonial y 2 individuales');
    agregarReservacion(4, 4, 4, 4, 4, 4, 4, 'Cancelado', 'Reserva cancelada antes del check-in');
    agregarReservacion(5, 5, 5, 5, 5, 5, 5, 'Confirmado', 'HabitaciÔøΩn con acceso directo a la playa');
    */
...
agregarFactura(1, 1, TO_DATE('2024-03-01', 'YYYY-MM-DD'), 10, 'Tarjeta de crÔøΩdito', 50000, 'Pagado');
agregarFactura(2, 2, TO_DATE('2024-03-02', 'YYYY-MM-DD'), 5, 'Efectivo', 60000, 'Pendiente');
agregarFactura(3, 3, TO_DATE('2024-03-03', 'YYYY-MM-DD'), 0, 'Tarjeta de crÔøΩdito', 80000, 'Pagado');
...
BEGIN
    ...
    dbms_output.put_line('CantÔøΩn: ' || v_canton);
    dbms_output.put_line('Distrito: ' || v_distrito);
    dbms_output.put_line('Detalle DirecciÔøΩn: ' || v_detalle_direccion);
    dbms_output.put_line('TelÔøΩfono: ' || v_telefono);
    dbms_output.put_line('NÔøΩmero de Pisos: ' || v_numero_pisos);
...
BEGIN
    ...
    dbms_output.put_line('Nombre: ' || v_nombre);
    dbms_output.put_line('DescripciÔøΩn: ' || v_descripcion);
...
EXCEPTION
    WHEN no_data_found THEN
        dbms_output.put_line('PromociÔøΩn con Id_Promocion ' || promocionid || ' no encontrada.');
    WHEN OTHERS THEN
        dbms_output.put_line('Error: ' || SQLERRM);
END;
...
EXCEPTION
    WHEN no_data_found THEN
        dbms_output.put_line('Tipo de promociÔøΩn con Id_Tipo_Promocion ' || tipo_promocionid || ' no encontrado.');
    WHEN OTHERS THEN
        dbms_output.put_line('Error: ' || SQLERRM);
END;
...
BEGIN
    ...
    dbms_output.put_line('AÔøΩo: ' || v_anio);
    dbms_output.put_line('Placa: ' || v_placa);
EXCEPTION
    WHEN no_data_found THEN
        dbms_output.put_line('VehÔøΩculo con Id_Vehiculo '
                             || vehiculoid
                             || ' no encontrado.');
END;
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        DBMS_OUTPUT.PUT_LINE('No se encontrÔøΩ ningÔøΩn huÔøΩsped con el ID ' || p_Id_Huesped);
    ELSE
        DBMS_OUTPUT.PUT_LINE('HuÔøΩsped con ID ' || p_Id_Huesped || ' modificado correctamente.');
    END IF;
END;
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        DBMS_OUTPUT.PUT_LINE('No se encontrÔøΩ ningÔøΩn huÔøΩsped con el ID ' || p_Id_Huesped);
    ELSE
        DBMS_OUTPUT.PUT_LINE('HuÔøΩsped con ID ' || p_Id_Huesped || ' borrado correctamente.');
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al borrar el huÔøΩsped: ' || SQLERRM);
END;
...
DBMS_OUTPUT.PUT_LINE(
            ...
            'NÔøΩmero de Camas: ' || v_Numero_Camas || ', ' ||
            'Vista: ' || v_Vista || ', ' ||
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        DBMS_OUTPUT.PUT_LINE('No se encontrÔøΩ ningÔøΩn tipo de habitaciÔøΩn con el ID ' || p_Id_TipoHabitacion);
    ELSE
        DBMS_OUTPUT.PUT_LINE('Tipo de habitaciÔøΩn con ID ' || p_Id_TipoHabitacion || ' modificado correctamente.');
    END IF;
END;
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        DBMS_OUTPUT.PUT_LINE('No se encontrÔøΩ ningÔøΩn tipo de habitaciÔøΩn con el ID ' || p_Id_TipoHabitacion);
    ELSE
        DBMS_OUTPUT.PUT_LINE('Tipo de habitaciÔøΩn con ID ' || p_Id_TipoHabitacion || ' borrado correctamente.');
    END IF;
END;
...
DBMS_OUTPUT.PUT_LINE(
            ...
            'NÔøΩmero de HabitaciÔøΩn: ' || v_Numero_Habitacion || ', ' ||
            'DescripciÔøΩn: ' || v_Descripcion || ', ' ||
            'Estado: ' || v_Estado
        );
    END LOOP;
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        DBMS_OUTPUT.PUT_LINE('No se encontrÔøΩ ninguna habitaciÔøΩn con el ID ' || p_Id_Habitacion);
    ELSE
        DBMS_OUTPUT.PUT_LINE('HabitaciÔøΩn con ID ' || p_Id_Habitacion || ' modificada correctamente.');
    END IF;
END;
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        DBMS_OUTPUT.PUT_LINE('No se encontrÔøΩ ninguna habitaciÔøΩn con el ID ' || p_Id_Habitacion);
    ELSE
        DBMS_OUTPUT.PUT_LINE('HabitaciÔøΩn con ID ' || p_Id_Habitacion || ' borrada correctamente.');
    END IF;
END;
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        DBMS_OUTPUT.PUT_LINE('No se encontrÔøΩ ningÔøΩn mantenimiento con el ID ' || p_Id_Mantenimiento);
    ELSE
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        DBMS_OUTPUT.PUT_LINE('No se encontrÔøΩ ningÔøΩn restaurante con el ID ' || p_Id_Restaurante);
    ELSE
...
BEGIN
    ...
    dbms_output.put_line('ID ReservaciÔøΩn Restaurante: ' || p_id_reservacion);
    ...
    dbms_output.put_line('Fecha de ReservaciÔøΩn: ' || TO_CHAR(v_fecha_reserva, 'YYYY-MM-DD'));
    dbms_output.put_line('Cantidad de Personas: ' || v_cantidad);

EXCEPTION
    WHEN no_data_found THEN
        dbms_output.put_line('No se encontrÔøΩ la reservaciÔøΩn con ID ' || p_id_reservacion);
    WHEN OTHERS THEN
        dbms_output.put_line('Error: ' || SQLERRM);
END;
...
BEGIN
    ...
    dbms_output.put_line('ID ReservaciÔøΩn: ' || p_id_reservacion);
    dbms_output.put_line('FK Huesped: ' || v_fk_huesped);
    dbms_output.put_line('FK Hotel: ' || v_fk_hotel);
    dbms_output.put_line('FK HabitaciÔøΩn: ' || v_fk_habitacion);
    dbms_output.put_line('FK PromociÔøΩn: ' || v_fk_promocion);
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        dbms_output.put_line('No se encontrÔøΩ una reservaciÔøΩn con el ID: ' || p_id_reservacion);
    WHEN OTHERS THEN
        dbms_output.put_line('Error: ' || SQLERRM);
END;
...
BEGIN
    actualizarReservacion(1, 1, 1, 1, 1, 'Confirmado', 'ReservaciÔøΩn para una noche en habitaciÔøΩn con jacuzzi',
        TO_DATE('2024-03-10', 'YYYY-MM-DD'), TO_DATE('2024-03-10', 'YYYY-MM-DD'));

    actualizarReservacion(2, 2, 2, 2, 2, 'Pendiente', 'HabitaciÔøΩn doble con vista a la ciudad',
        TO_DATE('2024-03-11', 'YYYY-MM-DD'), TO_DATE('2024-03-11', 'YYYY-MM-DD'));

    actualizarReservacion(3, 3, 3, 3, 3, 'Confirmado', 'HabitaciÔøΩn familiar con cama matrimonial y 2 individuales',
    ...
    actualizarReservacion(5, 5, 5, 5, 5, 'Confirmado', 'HabitaciÔøΩn con acceso directo a la playa',
...
BEGIN
    ...
    dbms_output.put_line('FK ReservaciÔøΩn: ' || v_fk_reservacion);
    dbms_output.put_line('Fecha EmisiÔøΩn: ' || TO_CHAR(v_fecha_emision, 'YYYY-MM-DD'));
    dbms_output.put_line('Descuento: ' || v_descuento || '%');
    dbms_output.put_line('MÔøΩtodo de Pago: ' || v_metodo_pago);
    dbms_output.put_line('Monto: ' || v_monto);
    dbms_output.put_line('Estado: ' || v_estado);

EXCEPTION
    WHEN NO_DATA_FOUND THEN
        dbms_output.put_line('No se encontrÔøΩ factura con ID ' || p_id_factura);
    WHEN OTHERS THEN
...
CREATE OR REPLACE VIEW vistaAÔøΩoVehiculo AS
SELECT Id_Vehiculo, Tipo, Marca, Modelo,AÔøΩo,Placa
FROM Vehiculo
WHERE AÔøΩo >= 2022
...
BEGIN
  ...
  dbms_output.put_line('El huÔøΩsped con ID ' || v_id_huesped || ' tiene ' || v_cantidad_reservaciones || ' reservaciones de restaurante.');
END;
...
BEGIN
    ...
    INSERT INTO Vehiculo (Id_Vehiculo, FK_Hotel, Tipo, Marca, Modelo, A√±o, Placa)
    VALUES (v_id_vehiculo, v_fk_hotel, v_tipo, v_marca, v_modelo, v_ano, v_placa);
...
EXCEPTION
    WHEN no_data_found THEN
        dbms_output.put_line('Veh√≠culo con Id_Vehiculo '
                             || vehiculoid
                             || ' no encontrado.');
END;
...
ALTER SEQUENCE EMPLEADO_SEQ INCREMENT BY 1;
...
CREATE OR REPLACE NONEDITIONABLE PACKAGE pkg_crud_reservaciones AS
  ...
  PROCEDURE agregar_reservacion(
    p_id_reservacion   IN Reservacion.Id_Reservacion%TYPE,
    p_fk_huesped       IN Reservacion.FK_Huesped%TYPE,
    p_fk_hotel         IN Reservacion.FK_Hotel%TYPE,
    p_fk_habitacion    IN Reservacion.FK_Habitacion%TYPE,
    p_fk_promocion     IN Reservacion.FK_Promocion%TYPE,
    p_estado           IN Reservacion.Estado%TYPE,
    p_comentarios      IN Reservacion.Comentarios%TYPE,
    p_fecha_checkin    IN Reservacion.Fecha_CheckIn%TYPE,
    p_fecha_checkout   IN Reservacion.Fecha_CheckOut%TYPE
  );

  -- Obtener reservaciÛn
  PROCEDURE obtener_reservacion(
    p_id_reservacion IN Reservacion.Id_Reservacion%TYPE
  );

  -- Modificar reservaciÛn
  PROCEDURE modificar_reservacion(
    p_id_reservacion   IN Reservacion.Id_Reservacion%TYPE,
    p_fk_huesped       IN Reservacion.FK_Huesped%TYPE,
    p_fk_hotel         IN Reservacion.FK_Hotel%TYPE,
    p_fk_habitacion    IN Reservacion.FK_Habitacion%TYPE,
...
CREATE OR REPLACE PACKAGE BODY pkg_crud_reservaciones AS
  ...
  BEGIN
    INSERT INTO Reservacion (
      Id_Reservacion, FK_Huesped, FK_Hotel, FK_Habitacion, FK_Promocion,
      Estado, Comentarios, Fecha_CheckIn, Fecha_CheckOut
    )
    VALUES (
      p_id_reservacion, p_fk_huesped, p_fk_hotel, p_fk_habitacion, p_fk_promocion,
      p_estado, p_comentarios, p_fecha_checkin, p_fecha_checkout
    );
    COMMIT;
  EXCEPTION
    WHEN OTHERS THEN
      ROLLBACK;
      DBMS_OUTPUT.PUT_LINE('Error al agregar reservaciÛn: ' || SQLERRM);
  END;
  ...
  AS
    v_fk_huesped     Reservacion.FK_Huesped%TYPE;
    v_fk_hotel       Reservacion.FK_Hotel%TYPE;
    v_fk_habitacion  Reservacion.FK_Habitacion%TYPE;
    v_fk_promocion   Reservacion.FK_Promocion%TYPE;
    v_estado         Reservacion.Estado%TYPE;
    v_comentarios    Reservacion.Comentarios%TYPE;
    v_fecha_checkin  Reservacion.Fecha_CheckIn%TYPE;
    v_fecha_checkout Reservacion.Fecha_CheckOut%TYPE;
  BEGIN
    SELECT
      FK_Huesped, FK_Hotel, FK_Habitacion, FK_Promocion,
      Estado, Comentarios, Fecha_CheckIn, Fecha_CheckOut
    INTO
      v_fk_huesped, v_fk_hotel, v_fk_habitacion, v_fk_promocion,
      v_estado, v_comentarios, v_fecha_checkin, v_fecha_checkout
    FROM
      Reservacion
    WHERE
      Id_Reservacion = p_id_reservacion;

    DBMS_OUTPUT.PUT_LINE('ID ReservaciÛn: ' || p_id_reservacion);
    DBMS_OUTPUT.PUT_LINE('FK Huesped: ' || v_fk_huesped);
    DBMS_OUTPUT.PUT_LINE('FK Hotel: ' || v_fk_hotel);
    DBMS_OUTPUT.PUT_LINE('FK HabitaciÛn: ' || v_fk_habitacion);
    DBMS_OUTPUT.PUT_LINE('FK PromociÛn: ' || v_fk_promocion);
    DBMS_OUTPUT.PUT_LINE('Estado: ' || v_estado);
    DBMS_OUTPUT.PUT_LINE('Comentarios: ' || v_comentarios);
    DBMS_OUTPUT.PUT_LINE('Fecha Check-In: ' || TO_CHAR(v_fecha_checkin, 'YYYY-MM-DD'));
    DBMS_OUTPUT.PUT_LINE('Fecha Check-Out: ' || TO_CHAR(v_fecha_checkout, 'YYYY-MM-DD'));
  ...
  EXCEPTION
    WHEN NO_DATA_FOUND THEN
      DBMS_OUTPUT.PUT_LINE('No se encontrÛ la reservaciÛn con ID: ' || p_id_reservacion);
    WHEN OTHERS THEN
      DBMS_OUTPUT.PUT_LINE('Error: ' || SQLERRM);
  END;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      ROLLBACK;
      DBMS_OUTPUT.PUT_LINE('Error al modificar reservaciÛn: ' || SQLERRM);
  END;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      ROLLBACK;
      DBMS_OUTPUT.PUT_LINE('Error al eliminar reservaciÛn: ' || SQLERRM);
  END;
...
--VA A IMPEDIR CAMBIAR EL ESTADO DE UNA RESERVACI√ìN A CANCELADO LUEGO DEL CHECK-IN
...
BEGIN
  IF :new.Estado = 'Cancelado' AND :old.FK_CheckIn IS NOT NULL THEN
    RAISE_APPLICATION_ERROR(-20003, 'No se puede cancelar una reservaci√≥n con check-in registrado');
  END IF;
END;
...
EXCEPTION
  WHEN ex_estado_reservacion THEN
    DBMS_OUTPUT.PUT_LINE('Error de Trigger: No se puede cancelar reservaci√≥n con Check-In');
END;
...
BEGIN
  IF :new.Costo > 10000 THEN
    RAISE_APPLICATION_ERROR(-20004, 'Costo de suministro excede el l√≠mite permitido');
  END IF;
END;
...
BEGIN
  INSERT INTO Suministro (Id_Suministro, FK_Proveedor, FK_Hotel, Nombre, Descripcion, Cantidad, Costo)
  VALUES (1, 1, 1, 'Producto X', 'Descripci√≥n', 10, 15000);
EXCEPTION
...
BEGIN
  IF TO_NUMBER(:new.Capacidad) < 10 THEN
    RAISE_APPLICATION_ERROR(-20005, 'La capacidad m√≠nima de un evento debe ser de al menos 10 personas');
  END IF;
END;
...
EXCEPTION
  WHEN ex_capacidad_evento THEN
    DBMS_OUTPUT.PUT_LINE('Error de Trigger: Capacidad m√≠nima no permitida');
END;
