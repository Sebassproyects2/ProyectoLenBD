...
BEGIN
    ...
    dbms_output.put_line('ID ReservaciÛn Restaurante: ' || p_id_reservacion);
    ...
    dbms_output.put_line('Fecha de ReservaciÛn: ' || TO_CHAR(v_fecha_reserva, 'YYYY-MM-DD'));
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        dbms_output.put_line('No se encontrÛ una reservaciÛn con el ID: ' || p_id_reservacion);
    WHEN OTHERS THEN
        dbms_output.put_line('Error: ' || SQLERRM);
END;
...
BEGIN
    actualizarReservacion(1, 1, 1, 1, 1, 'Confirmado', 'ReservaciÛn para una noche en habitaciÛn con jacuzzi',
        TO_DATE('2024-03-10', 'YYYY-MM-DD'), TO_DATE('2024-03-10', 'YYYY-MM-DD'));

    actualizarReservacion(2, 2, 2, 2, 2, 'Pendiente', 'HabitaciÛn doble con vista a la ciudad',
        TO_DATE('2024-03-11', 'YYYY-MM-DD'), TO_DATE('2024-03-11', 'YYYY-MM-DD'));

    actualizarReservacion(3, 3, 3, 3, 3, 'Confirmado', 'HabitaciÛn familiar con cama matrimonial y 2 individuales',
    ...
    actualizarReservacion(5, 5, 5, 5, 5, 'Confirmado', 'HabitaciÛn con acceso directo a la playa',
...
BEGIN
    ...
    dbms_output.put_line('FK ReservaciÛn: ' || v_fk_reservacion);
    dbms_output.put_line('Fecha EmisiÛn: ' || TO_CHAR(v_fecha_emision, 'YYYY-MM-DD'));
    dbms_output.put_line('Descuento: ' || v_descuento || '%');
    dbms_output.put_line('MÈtodo de Pago: ' || v_metodo_pago);
    dbms_output.put_line('Monto: ' || v_monto);
    dbms_output.put_line('Estado: ' || v_estado);

EXCEPTION
    WHEN NO_DATA_FOUND THEN
        dbms_output.put_line('No se encontrÛ factura con ID ' || p_id_factura);
    WHEN OTHERS THEN
